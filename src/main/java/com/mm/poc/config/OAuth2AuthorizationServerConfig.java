...
public class OAuth2AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
  ...
  public void configure(final AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
    ...
    endpoints.tokenStore(tokenStore(redisConnectionFactory())).tokenEnhancer(tokenEnhancerChain).authenticationManager(authenticationManager);
  }
  ...
  public JwtAccessTokenConverter accessTokenConverter() {
    ...
    KeyStoreKeyFactory keyStoreKeyFactory =
            new KeyStoreKeyFactory(new ClassPathResource("poc.jks"), "changeit".toCharArray());
    converter.setKeyPair(keyStoreKeyFactory.getKeyPair("poc"));
    return converter;
  }
